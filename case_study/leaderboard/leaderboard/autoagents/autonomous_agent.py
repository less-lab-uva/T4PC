...
class AutonomousAgent(object):
    ...
    def __init__(self, path_to_conf_file, *args, **kwargs):
        ...
        self.setup(path_to_conf_file, *args, **kwargs)
    ...
    def create_save_folder(self, name):
        self.save_path = pathlib.Path(os.environ['SAVE_PATH']) / name
        if self.save_path.exists():
            print("SAVE_PATH folder already exists, removing folder!")
        ...
        (self.save_path / 'supervision').mkdir(exist_ok=True)
        (self.save_path / 'rsv').mkdir(exist_ok=True)
