...
class LeaderboardEvaluator(object):
    ...
    def _load_and_run_scenario(self, args, config):
        ...
        try:
            ...
            self.agent_instance = getattr(self.module_agent, agent_class_name)(args.agent_config, args.output_type)
        ...
        try:
            ...
            if SAVE_PATH is not None:
                self.agent_instance.create_save_folder(scenario.name)
...
def main():
    ...
    parser.add_argument("--done", action="store_true", help="Done with routes, print global statistics.")
    ...
    parser.add_argument("--output_type", type=str, choices=["original", "dnn"], default="original", help="Type of output signal to send to Carla")

    arguments = parser.parse_args()
    print("init statistics_manager")
    statistics_manager = StatisticsManager()

    print(f"Output signal to send to Carla: {arguments.output_type}")
